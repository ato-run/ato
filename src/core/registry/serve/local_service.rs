...
impl LocalRegistryService {
    ...
    ) -> Result<Vec<crate::registry::store::PersistentStateRecord>> {
    ...
    pub(super) fn get_persistent_state(
        &self,
        state_id: &str,
    ) -> Result<Option<crate::registry::store::PersistentStateRecord>> {
        self.open_state_store()?
    ...
    pub(super) fn register_persistent_state(
        ...
        state_name: &str,
        path: &str,
    ) -> Result<crate::registry::store::PersistentStateRecord> {
    ...
    ) -> Result<Vec<crate::registry::store::ServiceBindingRecord>> {
    ...
    pub(super) fn get_service_binding(
        &self,
        binding_id: &str,
    ) -> Result<Option<crate::registry::store::ServiceBindingRecord>> {
    ...
    ) -> Result<crate::registry::store::ServiceBindingRecord> {

...
use super::manifest::{StaticWebManifestV1, canonical_jcs_bytes, validate_relative_path};
...
mod tests {
    ...
    fn receipt_rejects_unknown_fields_and_duplicate_blob_digests() {
        let input = include_str!("../tests/fixtures/static-web-bundle-receipt-jcs-v1/input.json");

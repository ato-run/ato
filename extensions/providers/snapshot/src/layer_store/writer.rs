...
//!
//! This is the inverse of [`LazyBlobReader`](crate::layer_store::LazyBlobReader): together
...
use super::chunk::{ChunkParams, chunk_content_defined, chunk_page_aligned};
use super::manifest::{BlobManifest, ChunkingKind, LayerKind};
...
mod tests {
    use super::*;
    use crate::layer_store::LazyBlobReader;

...
mod linux_impl {
    ...
    use crate::layer_store::{BlobManifest, CasStore, LazyBlobReader, MEMORY_PAGE_CHUNK_SIZE};
...
mod stub {
    ...
    impl PageSource {
        ...
        pub(crate) fn cas(
            _store: crate::layer_store::CasStore,
            _mem_blob: crate::layer_store::BlobManifest,
            _remote: Option<crate::layer_store::CasStore>,

...
use protocol::config::ConfigField;
use protocol::consent::{ConsentIdentity, ConsentRequiredDetails};
...
// discriminator (`protocol::consent::CONSENT_REQUIRED_REASON`) now live

...
| [NACELLE_SPEC](../../../../../docs/rfcs/accepted/NACELLE_SPEC.md) | Execute phase の spawn 契約を本 RFC から参照 |
| [RUNTIME_AND_BUILD_MODEL](../../../../../docs/rfcs/accepted/RUNTIME_AND_BUILD_MODEL.md) | `RuntimeProvisioner` trait を本 RFC が定義する上位層 |
| [EXECUTIONPLAN_ISOLATION_MODEL](../../../../../docs/rfcs/accepted/EXECUTIONPLAN_ISOLATION_MODEL.md) | PATH / env の default-deny を本 RFC が PATH にも拡張 |
| [SECURITY_AND_ISOLATION_MODEL](../../../../../docs/rfcs/accepted/SECURITY_AND_ISOLATION_MODEL.md) | PDF §5.4 の env default-deny を PATH に適用する実装根拠 |
| [archived CAPSULE_FORMAT_V2](../../../../../docs/rfcs/archived/CAPSULE_FORMAT_V2.md) | `ato.lock.json::runtime_tools` スキーマ拡張を本 RFC が規定 |

...
pub fn specs() -> Vec<IpcCommandSpec> {
    ...
    vec![
        ...
        spec("shell.openCapsuleLink",   SystemCapsule, &[Capability::LaunchSystemCapsule]),
        spec("shell.openStore",         SystemCapsule, &[Capability::LaunchSystemCapsule]),
        spec("shell.openSettings",      SystemCapsule, &[Capability::LaunchSystemCapsule]),
        spec("shell.closeWindow",       SystemCapsule, &[Capability::WindowsClose]),

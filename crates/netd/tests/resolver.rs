//! Integration tests for `netd::net::resolver` — Slice D (#299).
//!
...
async fn receipt_json_roundtrip() {
    use netd::net::receipt::{DnsResolutionRecord, NetworkReceiptEvent};
...
fn default_config_no_doh() {
    ...
    #[cfg(not(feature = "doh"))]
    {
        use netd::net::resolver::DohResolver;

...
pub const ATO_ERR_INSUFFICIENT_STORAGE: &str = "ATO_ERR_INSUFFICIENT_STORAGE";
pub const ATO_ERR_PORT_CONFLICT: &str = "ATO_ERR_PORT_CONFLICT";
pub const ATO_ERR_RELAUNCH_CONDITION_UNSATISFIED: &str = "ATO_ERR_RELAUNCH_CONDITION_UNSATISFIED";
pub const ATO_ERR_LAUNCH_CONDITION_PROMPT_REQUIRED_NONINTERACTIVE: &str =
    "ATO_ERR_LAUNCH_CONDITION_PROMPT_REQUIRED_NONINTERACTIVE";
pub const ATO_ERR_LAUNCH_CONDITION_SECRET_STORE_LOCKED: &str =
    "ATO_ERR_LAUNCH_CONDITION_SECRET_STORE_LOCKED";
pub const ATO_ERR_LAUNCH_CONDITION_SECRET_CREATE_FAILED: &str =
    "ATO_ERR_LAUNCH_CONDITION_SECRET_CREATE_FAILED";
pub const ATO_ERR_LAUNCH_CONDITION_STATE_CREATE_FAILED: &str =
    "ATO_ERR_LAUNCH_CONDITION_STATE_CREATE_FAILED";
pub const ATO_ERR_LAUNCH_CONDITION_SECRET_VALUE_MISSING: &str =
    "ATO_ERR_LAUNCH_CONDITION_SECRET_VALUE_MISSING";
pub const ATO_ERR_LAUNCH_CONDITION_SECRET_INJECTION_FAILED: &str =
    "ATO_ERR_LAUNCH_CONDITION_SECRET_INJECTION_FAILED";
pub const ATO_ERR_LAUNCH_CONDITION_STATE_TARGET_MISSING: &str =
    "ATO_ERR_LAUNCH_CONDITION_STATE_TARGET_MISSING";
pub const ATO_ERR_LAUNCH_CONDITION_STATE_MOUNT_FAILED: &str =
    "ATO_ERR_LAUNCH_CONDITION_STATE_MOUNT_FAILED";

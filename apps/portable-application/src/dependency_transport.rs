//! Digest-authoritative retrieval for sparse portable dependency objects.
//!
//! URLs are transport hints only. The referenced SHA-256 and declared size are
//! checked before fetched bytes can enter a bundle.
...
use crate::{bundle_sha256, validate_all_derivations};

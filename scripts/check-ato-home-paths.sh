...
ALLOWLIST='^(crates/capsule/src/foundation/common/paths.rs|crates/ato-desktop/src/settings.rs|crates/ato-desktop/src/cli_install.rs|crates/ato-cli/src/application/auth/storage.rs|crates/ato-cli/src/utils/local_input.rs|crates/ato-cli/src/app_control/session.rs|crates/capsule/src/adapters/capsule/cas_store.rs|crates/ato-cli/src/application/engine/install/support.rs|crates/ato-cli/src/adapters/registry/serve/registry_storage.rs|crates/ato-cli/src/adapters/registry/binding/proxy.rs|crates/ato-cli/src/cli/commands/uninstall.rs|crates/ato-cli/src/adapters/output/progressive/mod.rs|crates/ato-cli/src/application/engine/build/native_delivery/projection.rs|crates/ato-cli/src/adapters/registry/publish/upload_strategy/presigned.rs):'

MATCHES=$(rg -n "$PATTERN" crates/ato-cli/src crates/ato-desktop/src crates/capsule/src crates/ato-session-core/src || true)

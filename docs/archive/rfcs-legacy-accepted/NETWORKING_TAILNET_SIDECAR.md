...
author: "@egamikohsuke"
ssot:
  - "apps/ato/services/ato-tsnetd/"
  - "apps/ato/crates/capsule/src/adapters/tsnet/"
related: []
---
...
> 旧 ADR `docs/adr/2026-01-17_000000_embedded-tailnet-sidecar.md` は廃止済み。ソースコードの実装 (`apps/ato/services/ato-tsnetd/`, `apps/ato/crates/capsule/src/adapters/tsnet/`) を正本とする。
